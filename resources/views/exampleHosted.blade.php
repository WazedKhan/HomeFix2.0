...
<div class="container">
            ...
            <form action="{{ url('/pay') }}" method="POST" class="needs-validation">
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" value="{{ Auth::user()->name }}" name="customer_name" class="form-control" id="customer_name" placeholder=""
    ...
    <footer class="my-5 pt-5 text-muted text-center text-small">
        <p class="mb-1">&copy; 2022 HomeFix</p>
